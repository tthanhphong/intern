...
<?php do_action('script_notification') ?>
<!-- <div class="container-fluid">
<div class="row">
<div class="col-12">
<img src="wp-content/themes/themehandmade/img/bg-hero.png" alt="this is a background" style="   height: 89vh;
                                                                                                position: absolute;
                                                                                                width: 100%;
        ...
        <div class="container ">
            <div class="row justify-content-between ">
                ...
                <div class="col-lg-8 ">
                    ...
                    ?>
                        <h2>On the other hand, we denounce with righteous indignation and dislike men who are</h2>
                        <p>
                            <a href="# " class="btn btn-first ">Try for free</a>
                            <a href="# " class="btn btn-second ">See pricing</a>
                        </p>
            ...
            <div class="row ">
                ...
                <div class="col-lg-5 col-md-5 col-sm-12 mt-5 d-flex justify-content-center">
                    <div class="row mx-auto my-auto">
                        <img src="wp-content/themes/themehandmade/img/feature_2.png " alt="This is a image ">
                    </div>
                </div>
            </div>
        </div>
